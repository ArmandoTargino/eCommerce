    ...
    <div class="row g-3">
      <div class="col-md-5 col-lg-4 order-md-last">
        <h4 class="d-flex justify-content-between align-items-center mb-3">
          ...
          <span class="badge bg-secondary rounded-pill"><i class="fas fa-shopping-cart"></i></span>
        </h4>
        ...
        <form class="needs-validation" novalidate>
          <div class="row g-3">
            ...
            <div class="col-md-5">
              ...
              <select onchange="initStates()" id="country-select" class="form-select" id="country-select" required>
...
<script>
  var countries = "<?php echo $key ?>";
  var settings = {
    "url": "https://restfulcountries.com/api/v1/countries?fetch_type=slim",
    "method": "GET",
    "timeout": 0,
    "headers": {
      "Authorization": "Bearer "+countries
    },
  };
  ...
  $(document).ready(function() {
    ...
    $.ajax(settings).done(function(countries) {
  ...
  function initStates() {
    ...
    var settingsStates = {
      "url": 'https://restfulcountries.com/api/v1/countries/' + country + '/states?fetch_type=slim',
      "method": "GET",
      "timeout": 0,
      "headers": {
        "Authorization": "Bearer "+countries
    ...
    $.ajax(settingsStates).done(function(states) {
